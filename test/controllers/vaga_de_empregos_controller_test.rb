...
class VagaDeEmpregosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaga_de_emprego" do
    assert_difference("VagaDeEmprego.count") do
      post vaga_de_empregos_url, params: { vaga_de_emprego: { explicacao: @vaga_de_emprego.explicacao, nome: @vaga_de_emprego.nome, remuneracao: @vaga_de_emprego.remuneracao } }
    end
  ...
  test "should update vaga_de_emprego" do
    patch vaga_de_emprego_url(@vaga_de_emprego), params: { vaga_de_emprego: { explicacao: @vaga_de_emprego.explicacao, nome: @vaga_de_emprego.nome, remuneracao: @vaga_de_emprego.remuneracao } }
