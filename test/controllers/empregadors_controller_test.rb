...
class EmpregadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empregador" do
    assert_difference("Empregador.count") do
      post empregadors_url, params: { empregador: { cpf: @empregador.cpf, email: @empregador.email, nome: @empregador.nome, senha: @empregador.senha } }
    end
  ...
  test "should update empregador" do
    patch empregador_url(@empregador), params: { empregador: { cpf: @empregador.cpf, email: @empregador.email, nome: @empregador.nome, senha: @empregador.senha } }
