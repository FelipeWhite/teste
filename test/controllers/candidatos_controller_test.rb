...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference("Candidato.count") do
      post candidatos_url, params: { candidato: { cpf: @candidato.cpf, data_nascimento: @candidato.data_nascimento, email: @candidato.email, nome: @candidato.nome, senha: @candidato.senha } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { cpf: @candidato.cpf, data_nascimento: @candidato.data_nascimento, email: @candidato.email, nome: @candidato.nome, senha: @candidato.senha } }
